...
class MatchingController extends Controller
{
    public function matching(Request $request)
    {
        if (Auth::check()) {
            ...
            $query->whereNotNull('sns'); //sns欄を記入しているレコードを取り出す
    ...
    public function store(Request $request, Find_friend $find_friend)
    {
        $input = $request['star_profile'];
        $find_friend['user_id'] = Auth::id();
        $find_friend->fill($input)->save();
        return back();
    }
}
